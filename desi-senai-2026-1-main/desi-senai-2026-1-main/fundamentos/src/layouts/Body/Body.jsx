...
const Body = () => {
  ...
  const usuarios = [
    {nome:"Ana", idade: 24, cidade:"São José"},
    {nome:"Bruno", idade: 20, cidade:"Florianópolis"},
    {nome:"João", idade: 65, cidade:"Palhoça"},
    {nome:"Ana", idade: 43, cidade:"São José"},
    {nome:"Bruno", idade: 54, cidade:"Florianópolis"},
